...
public class SettingsServiceDALTest {
        ...
        public void init() {
                ...
                appSettings.put("SSL_CERT_ARN", "arn:aws-cn:acm:region:account:certificate/certificate_ID_1");
        ...
        public void testFromParameterStore() {
                ...
                assertThrows("null parameter name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromParameterStore(Parameter.builder().build());
                });
                assertThrows("Empty parameter name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromParameterStore(Parameter.builder().name("").build());
                });
                assertThrows("Blank parameter name is invalid pattern throws RuntimeException", RuntimeException.class,
                                () -> {
                                        SettingsServiceDAL.fromParameterStore(Parameter.builder().name(" ").build());
                                });
                assertThrows("Invalid pattern parameter name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromParameterStore(Parameter.builder().name("foobar").build());
                });
                ...
                Setting expectedValidSetting = Setting.builder()
                                ...
                                .description(null)
                                .build();
                assertEquals("Valid " + parameterName + " param equals " + settingName + " setting",
                                expectedValidSetting, SettingsServiceDAL.fromParameterStore(validParam));
                ...
                Setting expectedReadWriteSetting = Setting.builder()
                                ...
                                .description(null)
                                .build();
                assertEquals("Read/Write param " + readWriteParameterName + " equals APP_NAME setting",
                                expectedReadWriteSetting, SettingsServiceDAL.fromParameterStore(readWriteParameter));
                ...
                Setting expectedEmptySetting = Setting.builder()
                                ...
                                .description(null)
                                .build();
                assertEquals("Empty " + parameterName + " param equals blank setting", expectedEmptySetting,
                                SettingsServiceDAL.fromParameterStore(emptyParameter));
                ...
                Setting expectedSecretSetting = Setting.builder()
                                ...
                                .description(null)
                                .build();
                assertEquals("Valid secret param equals secure setting", expectedSecretSetting,
                                SettingsServiceDAL.fromParameterStore(secretParameter));
        }
        ...
        public void testToParameterStore() {
                ...
                assertThrows("null setting throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toParameterStore(null);
                });
                assertThrows("null setting name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toParameterStore(Setting.builder().build());
                });
                assertThrows("Empty setting name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toParameterStore(Setting.builder().name("").build());
                });
                assertThrows("Blank setting name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toParameterStore(Setting.builder().name(" ").build());
                });
                ...
                Setting settingNullValue = Setting.builder()
                                ...
                                .readOnly(false)
                                .build();
                assertEquals("null setting value equals N/A parameter value", expectedEmptyParameter,
                                SettingsServiceDAL.toParameterStore(settingNullValue));
                ...
                Setting settingEmptyValue = Setting.builder()
                                ...
                                .readOnly(false)
                                .build();
                assertEquals("Empty setting value equals N/A parameter value", expectedEmptyParameter,
                                SettingsServiceDAL.toParameterStore(settingEmptyValue));
                ...
                Setting settingBlankValue = Setting.builder()
                                ...
                                .readOnly(false)
                                .build();
                assertEquals("Blank setting value equals N/A parameter value", expectedBlankParameter,
                                SettingsServiceDAL.toParameterStore(settingBlankValue));
                ...
                Setting settingWithValue = Setting.builder()
                                ...
                                .readOnly(false)
                                .build();
                assertEquals("Setting value equals parameter value", expectedValueParameter,
                                SettingsServiceDAL.toParameterStore(settingWithValue));
                ...
                Setting settingSecretValue = Setting.builder()
                                ...
                                .readOnly(false)
                                .build();
                assertEquals("Setting secret value equals secure parameter", expectedSecretParameter,
                                SettingsServiceDAL.toParameterStore(settingSecretValue));
        }
        ...
        public void testFromTenantParameterStore() {
                ...
                String parameterName = "/" + SettingsServiceDAL.SAAS_BOOST_PREFIX + "/" + env + "/tenant/" + tenantId
                                + "/DB_HOST";

                assertThrows("null tenant id throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromTenantParameterStore(null,
                                        Parameter.builder().name(parameterName).build());
                });
                assertTrue("null parameter returns null setting",
                                SettingsServiceDAL.fromTenantParameterStore(tenantId, null) == null);
                assertThrows("null parameter name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromTenantParameterStore(tenantId, Parameter.builder().build());
                });
                assertThrows("Empty parameter name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromTenantParameterStore(tenantId, Parameter.builder().name("").build());
                });
                assertThrows("Blank parameter name is invalid pattern throws RuntimeException", RuntimeException.class,
                                () -> {
                                        SettingsServiceDAL.fromTenantParameterStore(tenantId,
                                                        Parameter.builder().name(" ").build());
                                });
                assertThrows("Invalid pattern parameter name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromTenantParameterStore(tenantId,
                                        Parameter.builder().name("foobar").build());
                });
                ...
                Setting expectedValidSetting = Setting.builder()
                                ...
                                .description(null)
                                .build();
                assertThrows("Mismatched tenant id's throw RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.fromTenantParameterStore(UUID.randomUUID(), validParam);
                });
                assertEquals("Valid DB_HOST param equals DB_HOST setting", expectedValidSetting,
                                SettingsServiceDAL.fromTenantParameterStore(tenantId, validParam));

                // Can't call ssm:PutParameter with a null or empty value, so we use N/A as a
                // sentinel value in parameter store
                ...
                Setting expectedBlankSetting = Setting.builder()
                                ...
                                .description(null)
                                .build();
                assertEquals("Valid DB_HOST param equals DB_HOST setting", expectedBlankSetting,
                                SettingsServiceDAL.fromTenantParameterStore(tenantId, blankParam));
                ...
                Setting expectedSecretSetting = Setting.builder()
                                ...
                                .description(null)
                                .build();
                assertEquals("Valid DB_HOST param equals DB_HOST setting", expectedSecretSetting,
                                SettingsServiceDAL.fromTenantParameterStore(tenantId, secretParam));
        }
        ...
        public void testToTenantParameterStore() {
                ...
                assertThrows("null tenant id throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toTenantParameterStore(null, Setting.builder().name(settingName).build());
                });
                assertThrows("null setting throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toTenantParameterStore(tenantId, null);
                });
                assertThrows("null setting name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toTenantParameterStore(tenantId, Setting.builder().build());
                });
                assertThrows("Empty setting name throws RuntimeException", RuntimeException.class, () -> {
                        SettingsServiceDAL.toTenantParameterStore(tenantId, Setting.builder().name("").build());
                });
                ...
                Setting settingNullValue = Setting.builder()
                                ...
                                .build();
                assertEquals("null setting value equals N/A parameter value", expectedEmptyParameter,
                                SettingsServiceDAL.toTenantParameterStore(tenantId, settingNullValue));
                ...
                Setting settingEmptyValue = Setting.builder()
                                ...
                                .build();
                assertEquals("Empty setting value equals N/A parameter value", expectedEmptyParameter,
                                SettingsServiceDAL.toTenantParameterStore(tenantId, settingEmptyValue));
                ...
                Setting settingBlankValue = Setting.builder()
                                ...
                                .build();
                assertEquals("Blank setting value equals N/A parameter value", expectedBlankParameter,
                                SettingsServiceDAL.toTenantParameterStore(tenantId, settingBlankValue));
                ...
                Setting settingWithValue = Setting.builder()
                                ...
                                .build();
                assertEquals("Setting value equals parameter value", expectedValueParameter,
                                SettingsServiceDAL.toTenantParameterStore(tenantId, settingWithValue));
                ...
                Setting settingSecretValue = Setting.builder()
                                ...
                                .build();
                assertEquals("Setting secret value equals secure parameter", expectedSecretParameter,
                                SettingsServiceDAL.toTenantParameterStore(tenantId, settingSecretValue));
        }
        ...
        public void testToAppConfigNoExtensions() throws Exception {
                ...
                assertEquals("AppConfig with no extensions and null billing provider", expected,
                                SettingsServiceDAL.toAppConfig(appSettings, null));
        }
        ...
        public void testRdsOptionsSorting() throws Exception {
                ...
                try (InputStream json = Files.newInputStream(Path.of(
                                this.getClass().getClassLoader().getResource("rdsInstancesUnsorted.json").toURI()))) {
                        LinkedHashMap<String, Object> options = Utils.fromJson(json, LinkedHashMap.class);
                        ArrayList<LinkedHashMap<String, Object>> instances = (ArrayList<LinkedHashMap<String, Object>>) options
                                        .get("instances");
                        ...
                        for (int i = instances.size(); i-- > 0;) {
                                ...
                                Integer generation = Integer
                                                .valueOf(((String) instance.get("instance")).substring(1, 2));
